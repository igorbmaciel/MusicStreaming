...
namespace WCFMusicStreamingLibrary.MusicStreamingManager {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="MusicStreamingManager.IMusicStreamingManagerService")]
    public interface IMusicStreamingManagerService {
        ...
        bool AddMusic(string name, System.DateTime time, string artist, string album);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMusicStreamingManagerService/AddMusic", ReplyAction="http://tempuri.org/IMusicStreamingManagerService/AddMusicResponse")]
        System.Threading.Tasks.Task<bool> AddMusicAsync(string name, System.DateTime time, string artist, string album);
        ...
        WCFMusicStreamingLibrary.MusicStreamingManager.Music[] GetAllMusics();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMusicStreamingManagerService/GetAllMusics", ReplyAction="http://tempuri.org/IMusicStreamingManagerService/GetAllMusicsResponse")]
        System.Threading.Tasks.Task<WCFMusicStreamingLibrary.MusicStreamingManager.Music[]> GetAllMusicsAsync();
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IMusicStreamingManagerServiceChannel : WCFMusicStreamingLibrary.MusicStreamingManager.IMusicStreamingManagerService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class MusicStreamingManagerServiceClient : System.ServiceModel.ClientBase<WCFMusicStreamingLibrary.MusicStreamingManager.IMusicStreamingManagerService>, WCFMusicStreamingLibrary.MusicStreamingManager.IMusicStreamingManagerService {
        ...
        public bool AddMusic(string name, System.DateTime time, string artist, string album) {
            return base.Channel.AddMusic(name, time, artist, album);
        }
        
        public System.Threading.Tasks.Task<bool> AddMusicAsync(string name, System.DateTime time, string artist, string album) {
            return base.Channel.AddMusicAsync(name, time, artist, album);
        }
        
        public WCFMusicStreamingLibrary.MusicStreamingManager.Music[] GetAllMusics() {
            return base.Channel.GetAllMusics();
        }
        
        public System.Threading.Tasks.Task<WCFMusicStreamingLibrary.MusicStreamingManager.Music[]> GetAllMusicsAsync() {
